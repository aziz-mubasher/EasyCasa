...
export const CATALOG: readonly CatalogItem[] = [
  ...
  },
  {
    ...
    labelEs: 'Valoración (AVM + revisión del agente)',
    category: 'valuation',
    priceModel: 'fixed',
    amountCents: eur(99),
    ivaApplicable: true,
  ...
  },
  {
    ...
    labelEs: 'Verificación de conformidad (RTI, técnico)',
    category: 'documents',
    priceModel: 'fixed',
    amountCents: eur(390),
    ivaApplicable: true,
  ...
  },
  {
    ...
    labelEs: 'Coordinación del rogito (con notario)',
    category: 'closing',
    priceModel: 'fixed',
    amountCents: eur(250),
    ivaApplicable: true,
  },
  {
    ...
    labelEs: 'Redacción del contrato de arrendamiento',
    category: 'rental',
    priceModel: 'fixed',
    amountCents: eur(120),
    ivaApplicable: true,
