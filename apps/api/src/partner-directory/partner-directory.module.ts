...
import { PartnerDirectoryPartnerController } from './partner-directory-partner.controller';
...
@Module({
  imports: [DbModule, UsersModule, AuthorityModule, BillingModule],
  controllers: [
    PartnerDirectoryController,
    PartnerDirectoryPartnerController,
    AdminPartnerDirectoryController,
  ],
