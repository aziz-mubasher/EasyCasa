...
function stubConfig(over: Partial<ApiConfig> = {}): ApiConfig {
  return {
    ...
    AI_URL: 'http://ai:8000',
    AI_INTERNAL_TOKEN: '',
    ASTE_PIPELINE_POLL_MS: 10_000,
    ASTE_OCR_TIMEOUT_MS: 600_000,
    ASTE_EXTRACT_TIMEOUT_MS: 300_000,
    ASTE_EMBED_TIMEOUT_MS: 120_000,
    ASTE_TRANSLATE_TIMEOUT_MS: 120_000,
    ASTE_CHAT_TIMEOUT_MS: 120_000,
