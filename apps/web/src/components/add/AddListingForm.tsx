    ...
    <section className="mx-auto max-w-2xl px-5 py-12">
      ...
      {step === 1 && canImportCasafari && (
        <div className="mb-6 rounded-xl border border-line bg-white p-4">
          <p className="text-sm font-medium mb-1">{t('casafari.folderLinkTitle')}</p>
          <p className="text-sm text-muted mb-3">{t('casafari.folderLinkBody')}</p>
          <Link href="/imports/casafari" className="text-sm text-azure underline hover:no-underline">
            {t('casafari.folderLinkCta')}
          </Link>
        </div>
      )}
