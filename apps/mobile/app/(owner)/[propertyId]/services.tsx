...
export default function ServicesScreen() {
  ...
  useLocalSearchParams<{ propertyId: string }>(); // property scope (persisted on order)
  ...
  // Items already covered by the chosen package are shown as disabled/covered.
...
const styles = StyleSheet.create({
  ...
  section: { fontSize: 13, fontWeight: '600', marginBottom: 8, marginTop: 16, textTransform: 'uppercase' },
  covered: { opacity: 0.6 },
