...
```
EasyCasa (MUNDIDA) — counsel review packet (GDPR core + LGL-1 Legenda)
```
...
• LGL-1 addendum for the not-yet-public “Legenda” feature (Q-A1–Q-A6)

Context for LGL-1: Legenda lets users upload Italian judicial-auction documents
...
```
EasyCasa (MUNDIDA) — pacchetto di revisione legale (GDPR + LGL-1 Legenda)
```
...
| 8 | **LGL-1** Legenda (Q-A1–Q-A6) | `docs/legal/aste-counsel-addendum-lgl1.md` | https://github.com/aziz-mubasher/EasyCasa/blob/main/docs/legal/aste-counsel-addendum-lgl1.md |
