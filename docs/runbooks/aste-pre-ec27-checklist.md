# Pre-EC-27 checklist — Legenda monetization lane
...
**Dispatch rule:** EC-27 (payments split) may be **dispatched for build** — gates **(a)(b) ✓**. Prefer completing **(c)** Drive GT before charging real users.
