...
**Status:** LIFTED — G7 cleared (`NEXT_PUBLIC_DEMO_MODE=false` on VPS, site indexable). Merged to `main` and web-deployed.

T33 SEO wiring landed in PR **[K EC 1.46] T33 SEO wiring — JSON-LD hardening, sitemap, sell-privately schema** (#140).
...
CI does not run Lighthouse. From a machine that can reach production:
