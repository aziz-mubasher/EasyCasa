...
| G3 row 9 | Signed; `paid_placement` column + preferential sort + paid labels; tracking still stripped |
...
- Do not assume monetised directory was “behind a flag” — it needed schema.
